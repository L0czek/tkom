...
std::wstring repr(TokenType type) {
    switch (type) {
        case TokenType::IDENTIFIER:     return L"IDENTIFIER";       break;
        case TokenType::INTCONST:       return L"INTCONST";         break;
        case TokenType::STRINGCONST:    return L"STRINGCONST";      break;
        case TokenType::PLUS:           return L"PLUS `+`";             break;
        case TokenType::MINUS:          return L"MINUS `-`";            break;
        case TokenType::STAR:           return L"STAR `*`";             break;
        case TokenType::DIVIDE:         return L"DIVIDE `/`";           break;
        case TokenType::MODULO:         return L"MODULO `%`";           break;
        case TokenType::ASSIGN:         return L"ASSIGN `=`";           break;
        case TokenType::EQUAL:          return L"EQUAL `==`";            break;
        case TokenType::NOT_EQUAL:      return L"NOT_EQUAL `!=`";        break;
        case TokenType::LESS:           return L"LESS `<`";             break;
        case TokenType::GREATER:        return L"GREATER `>`";          break;
        case TokenType::LESS_EQUAL:     return L"LESS_EQUAL`<=`";       break;
        case TokenType::GREATER_EQUAL:  return L"GREATER_EQUAL `>=`";    break;
        case TokenType::AMPERSAND:      return L"AMPERSAND `&`";        break;
        case TokenType::BIT_OR:         return L"BIT_OR `|`";           break;
        case TokenType::XOR:            return L"XOR `^`";              break;
        case TokenType::SHIFT_RIGHT:    return L"SHIFT_RIGHT `>>`";      break;
        case TokenType::SHIFT_LEFT:     return L"SHIFT_LEFT `<<`";       break;
        case TokenType::BIT_NEG:        return L"BIT_NEG `~`";          break;
        case TokenType::BOOLEAN_OR:     return L"BOOLEAN_OR `||`";       break;
        case TokenType::BOOLEAN_AND:    return L"BOOLEAN_AND `&&`";      break;
        case TokenType::BOOLEAN_NEG:    return L"BOOLEAN_NEG `!`";      break;
        case TokenType::L_PAREN:        return L"L_PAREN `(`";          break;
        case TokenType::R_PAREN:        return L"R_PAREN `)`";          break;
        case TokenType::LI_PAREN:       return L"LI_PAREN `[`";         break;
        case TokenType::RI_PAREN:       return L"RI_PAREN `]`";         break;
        case TokenType::LS_PAREN:       return L"LS_PAREN `{`";         break;
        case TokenType::RS_PAREN:       return L"RS_PAREN `}`";         break;
        case TokenType::COLON:          return L"COLON `:`";            break;
        case TokenType::COMMA:          return L"COMMA `,`";            break;
        case TokenType::SEMICOLON:      return L"SEMICOLON `;`";        break;
        case TokenType::TYPE_DECL:      return L"TYPE_DECL `->`";        break;
        case TokenType::END_OF_FILE:    return L"END_OF_FILE";      break;
        case TokenType::KW_FN:          return L"KW_FN `fn`";            break;
        case TokenType::KW_FOR:         return L"KW_FOR `for`";           break;
        case TokenType::KW_WHILE:       return L"KW_WHILE `while`";         break;
        case TokenType::KW_IF:          return L"KW_IF `if`";            break;
        case TokenType::KW_ELSE:        return L"KW_ELSE `else`";          break;
        case TokenType::KW_ELIF:        return L"KW_ELIF `elif";          break;
        case TokenType::KW_RETURN:      return L"KW_RETURN `return`";        break;
        case TokenType::KW_LET:         return L"KW_LET `let`";           break;
        case TokenType::INVALID:        return L"INVALID";          break;
        default: return L"No such token";
    }
}
...
std::wstring position_in_file(const Position& position) {
    return concat(L"Line ", std::to_wstring(position.line_number), L" column ", std::to_wstring(position.column_number), L" :\n");
}
